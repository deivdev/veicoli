...
def run_migrations(db: Session) -> None:
    ...
    added_owner = _add_column(db, "vehicles", "owner_id", "INTEGER")
    ...
    if first_user_id is None:
        # Nessun utente ancora: i veicoli orfani (se ce ne sono) restano tali e
        # verranno assegnati al prossimo avvio, dopo il seed dell'admin.
        return
